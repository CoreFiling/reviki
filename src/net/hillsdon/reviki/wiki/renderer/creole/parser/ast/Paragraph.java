...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedParagraph;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class Paragraph extends ImmutableRenderNode {

  protected RenderNode body;

  public Paragraph(RenderNode body) {
    this.body = body;
  }
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedParagraph(res.get(0)));
    return out;
  }
