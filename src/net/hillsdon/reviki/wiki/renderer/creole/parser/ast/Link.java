...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedLink;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class Link extends ImmutableRenderNode {
  ...
  public Link(String target, String title, final LinkPartsHandler handler) {
  ...
  public Link(String target, final LinkPartsHandler handler) {
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedLink(page, this, parts, urlOutputFilter, handler));
    return out;
  }
