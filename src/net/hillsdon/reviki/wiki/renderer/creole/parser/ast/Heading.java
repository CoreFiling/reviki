...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedHeading;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class Heading extends ImmutableRenderNode {
  protected int level;

  protected RenderNode body;

  public Heading(int level, RenderNode body) {
    this.level = level;
    this.body = body;
  }
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedHeading(level, contents.get(0)));
    return out;
  }
