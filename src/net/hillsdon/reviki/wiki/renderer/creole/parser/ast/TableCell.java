...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedTableCell;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class TableCell extends ImmutableRenderNode {
  protected RenderNode body;

  public TableCell(RenderNode body) {
    this.body = body;
  }
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedTableCell(contents.get(0)));
    return out;
  }
