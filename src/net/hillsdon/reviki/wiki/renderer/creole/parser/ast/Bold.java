...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedBold;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class Bold extends ImmutableRenderNode {

  protected RenderNode body;

  public Bold(RenderNode body) {
    this.body = body;
  }
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedBold(res.get(0)));
    return out;
  }
