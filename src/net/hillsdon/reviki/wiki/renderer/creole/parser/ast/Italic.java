...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedItalic;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class Italic extends ImmutableRenderNode {

  protected RenderNode body;

  public Italic(RenderNode body) {
    this.body = body;
  }
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedItalic(res.get(0)));
    return out;
  }
