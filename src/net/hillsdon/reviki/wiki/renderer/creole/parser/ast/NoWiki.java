...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedNoWiki;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class NoWiki extends ImmutableRenderNode {
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedNoWiki(contents));
    return out;
  }
