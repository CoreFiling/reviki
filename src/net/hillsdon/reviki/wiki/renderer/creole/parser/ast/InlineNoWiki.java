...
import net.hillsdon.reviki.wiki.renderer.creole.parser.ast.result.RenderedInlineNoWiki;
import net.hillsdon.reviki.wiki.renderer.result.ResultNode;

public class InlineNoWiki extends ImmutableRenderNode {
  ...
  public List<ResultNode> render(PageInfo page, String text, RenderNode parent, URLOutputFilter urlOutputFilter) {
    ...
    out.add(new RenderedInlineNoWiki(contents));
    return out;
  }
