...
public class TestSvnWikiLinkPartHandler extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    PageStoreConfiguration configuration = new FakeConfiguration("other", "http://other.example.com/%s");
    _handler = new SvnWikiLinkPartHandler(SvnWikiLinkPartHandler.ANCHOR, _store, _internalLinker, configuration);
  }
