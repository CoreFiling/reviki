...
public class TestSvnWikiLinkPartHandler extends TestCase {
  ...
  public void testForeignWikiPageAlwaysExists() throws Exception {
    String html = _handler.handle(new PageReferenceImpl("Page"), "Page", new LinkParts("Page", "other", "Page", null, null), URLOutputFilter.NULL);
    assertTrue(html.contains("inter-wiki"));
  }
  
  public void testWikiPageNotExists() throws Exception {
    String html = _handler.handle(new PageReferenceImpl("Page"), "Page", new LinkParts("Page", null, "Page", null, null), URLOutputFilter.NULL);
  ...
  public void testAcronymThatExists() throws Exception {
    ...
    String html = _handler.handle(new PageReferenceImpl("EX"), "EX", new LinkParts("EX", null, "EX", null, null), URLOutputFilter.NULL);
  ...
  public void testAcronymNotExists() throws Exception {
    ...
    String html = _handler.handle(new PageReferenceImpl("ABC"), "ABC", new LinkParts("ABC", null, "ABC", null, null), URLOutputFilter.NULL);
  ...
  public void testAcronymForeign() throws Exception {
    /* Should be a link and should be marked as existing */
    String html = _handler.handle(new PageReferenceImpl("ABC"), "ABC", new LinkParts("ABC", "other", "ABC", null, null), URLOutputFilter.NULL);
    assertTrue(html.contains("<a"));
    assertTrue(html.contains("inter-wiki"));
  }
}
