...
public class DelegatingRenderer extends HtmlRenderer {
  ...
  private final Function<String, String> _defaultSyntax;

  public DelegatingRenderer(final SimplePageStore pageStore, final LinkPartsHandler linkHandler, final LinkPartsHandler imageHandler, final Supplier<List<Macro>> macros, final Function<String, String> defaultSyntax) {
    _defaultSyntax = defaultSyntax;
  ...
  public DelegatingRenderer(final LinkResolutionContext resolver, final Function<String, String> defaultSyntax) {
    _defaultSyntax = defaultSyntax;
    _renderers = new LinkedHashMap<SyntaxFormats, HtmlRenderer>();
  ...
  private SyntaxFormats getSyntax(final PageInfo page) {
    if (page != null) {
      return page.getSyntax(_defaultSyntax);
    }
