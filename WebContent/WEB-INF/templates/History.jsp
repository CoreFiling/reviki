...
<tiles:insertTemplate template="SiteTemplate.jsp">
  ...
  <tiles:putAttribute name="content">
    <form method="get" name="compareForm" action="<c:url value="${encodedPageName}"/>">
      <div class="row">
        <div class="col-sm-11">
          <table class="history table table-bordered table-striped table-condensed">
            <tr class="history">
              ...
              <th class="history" colspan="2"><input class="btn btn-default center-block" type="submit" value="Compare" name="compare" /></th>
            </tr>
            <tr class="history">
